          ...
          <div class="signupModal ">
            ...
            @endif
               <form id="registerForm" action="{{route('store.user')}}" method="post">
                  ...
                  <button type="submit" class="login-btn">SIGN UP</button><br><br>
                  <a style="margin-left: 200px;" href="{{ route('login', ['apiKey' => $requestedParams['apiKey'], 'wallId' => $requestedParams['wallId'], 'userId' => $requestedParams['userId'], 'sub4' => $requestedParams['sub4'], 'sub5' => $requestedParams['sub5'], 'sub6' => $requestedParams['sub6']]) }}">Login Here</a>
               </div>
               </form>
            </div>
